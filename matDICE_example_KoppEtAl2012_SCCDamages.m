...
% Load MiniCAM based scenario
	...
	IndustrialCO2 = [26.53 31.81 38.01 45.14 51.74 57.80 62.75 67.78 72.89 76.67 80.46 83.77 86.53 88.68 90.17 90.96 91.03 90.39 89.05 87.04 84.40 81.04 77.06 72.55 67.63 62.43 57.06 51.65 46.28 41.07 36.09];
...
% 2.5 C stabilization reference
	...
	[a,Stabilization] = matDICE(specMCam{:},spec_disc{1}{:},'calcdamages','1./(1+exp(-(Temperature-2.6)*100))','T2xCO2',3,'monotonicAbatement','startAbatement',ones(size(Base(1).p.t))*.9,'coarseners',2,'display','iter');
